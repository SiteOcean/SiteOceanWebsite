...
const HomePage=()=>{
  ...
  <div className="bg-gradient-to-r from-[#44d0e2] via-[#59d7e7] to-purple-400 relative h-64 w-full pl-12 pt-12">
    ...
    <h1 className="underline text-white font-semibold">Business Profile Setup</h1>
    <p className="mt-6 text-[20px] font-bold text-white pr-3">
      Easily create and customize your business profile to attract more local customers.
    </p>
  </div>

  {/* Card 2: Real-Time Product Updates */}
  <div className="bg-gradient-to-r from-purple-400 via-[#59d7e7] to-[#44d0e2] h-64 w-full pl-12 pt-12 relative">
    ...
    <h1 className="underline text-white font-semibold">Instant Product Updates</h1>
    <p className="mt-6 text-[20px] font-bold text-blue-50 pr-3">
      Update your products, offers, and promotions in real-time to engage customers quickly.
    </p>
  </div>

  {/* Card 3: Nearby Business Visibility */}
  <div className="bg-gradient-to-r from-[#44d0e2] via-[#59d7e7] to-purple-400 relative h-64 w-full pl-12 pt-12">
    <span className="absolute h-12 w-12 border border-[#9ee4e4] bottom-1 sm:bottom-2 left-1 sm:left-6 rounded-full"></span>
    <span className="absolute h-[80px] w-[80px] border border-[#9fe9e9] top-3 right-1 md:right-6 rounded-full"></span>
    <h1 className="underline text-white font-semibold">Boost Local Visibility</h1>
    <p className="mt-6 text-[20px] font-bold text-white pr-3">
      Enhance your reach with hyper-local visibility, connecting with customers nearby.
    </p>
  </div>
</div>
