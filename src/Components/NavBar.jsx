...
const NavBar = () => {
  ...
  return (
    <nav className=" w-full bg-[#3384ee] text-[white] sticky top-0 z-50 shadow-sm shadow-[#eebbfd]">
        ...
        {isMenuOpen ? (
          ...
          />
            ...
            <div id='nav' className="hidden sm:block sm:ml-6 text-white">
              ...
              <Link href="/">
                  <span style={{fontWeight:router.pathname === "/" ? "bold" : "normal"}} className=" md:hover:bg-white hover:text-[#3384ee] px-3 py-2 rounded-md ">Home</span>
                </Link>
                <Link href="/Layouts/AboutPage">
                  <span style={{fontWeight:router.pathname === "/Layouts/AboutPage" ? "bold" : "normal"}} className=" md:hover:bg-white hover:text-[#3384ee] px-3 py-2 rounded-md ">About</span>
                </Link>
                <Link href="/Layouts/ContactPage">
                  <span style={{fontWeight:router.pathname === "/Layouts/ContactPage" ? "bold" : "normal"}} className=" md:hover:bg-white hover:text-[#3384ee] px-3 py-2 rounded-md ">Contact</span>
                </Link>
              </div>
            </div>
            {/* <span className='hidden sm:block w-[150px]'></span> */}

            {isMenuOpen ? <div id='nav' className={`md:hidden border-t fixed transform-gpu transition-all text-center opacity-95 -z-10 left-0 min-h-[200px] font-bold right-0 py-3 duration-1500 bg-[#3384ee] text-[white]  ${isMenuOpen ? "translate-y-12 top-2" : "translate-y-12 -top-[250px]"}`}>
