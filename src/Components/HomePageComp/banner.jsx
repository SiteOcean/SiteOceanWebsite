...
const HomeBanner = () => {
  ...
  return (
    <div className="relative bgimg  w-full min-h[70vh] md:min-h-[90vh] pt-8 pb-3 md:pt-6 flex flex-col md:items-center md:justify-center" >
          ...
          eraseSpeed={30}
          typingDelay={300}
          className="bg-gradient-to-r  sm:p-0 from-violet-700 via-purple-600 to-pink-500 text-transparent bg-clip-text text-[15px] md:text-[30px] "
        />
