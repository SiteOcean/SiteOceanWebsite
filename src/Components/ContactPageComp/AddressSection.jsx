  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center h-screen p-6 sm:p-0">
      ...
      <div className="flex flex-col space-y-3 mb-2 text-gray-600">
              <div>
              <h3 className="text-xl font-bold mb-2 text-[#b936ec] underline underline-offset-4">Company</h3>
              <p className="text-gray-700 font-serif lg:w-[50%]">Site Ocean Private Limited</p>
              </div> 
              <div>
            <h3 className="text-xl font-bold mb-1 text-[#b936ec]  underline underline-offset-4">Office Address</h3>
          ...
          <div>
            <h3 className="text-xl font-bold mb-1 text-[#b936ec]  underline underline-offset-4">Registered Office Address</h3>
            ...
            <div>
              <h3 className="text-xl font-bold space-y-2 text-[#b936ec]  underline underline-offset-4">Mobile</h3>
              <p className="font-semibold text-[#5f5c5c]">+91 - 8122183129</p>
              </div> 
            <div>
              <h3 className="text-xl font-bold mb-2 space-y-2 text-[#b936ec]  underline underline-offset-4">Email</h3>
              <p className=" underline text-[#cc4fe6]">info@siteocean.in</p>
              </div>   
            </div>
      </div>
    </div>
