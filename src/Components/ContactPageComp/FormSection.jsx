...
const FormSection = () => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center mt-3 sm:mt-0 justify-center">
      ...
      <h1 className="text-[16px] md:text-3xl font-bold mb-3 mt-3 md:mt-1 text-[#59d7e7]">Get in Touch</h1>
      ...
      <form onSubmit={handleSubmit} className="w-[70%] sm:w-full max-w-lg ">
        ...
        <div className="flex items-center justify-between">
          <button type="submit" className="bg-[#59d7e7] w-[100px] mx-auto hover:bg-blue-700 justify-center flex text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
