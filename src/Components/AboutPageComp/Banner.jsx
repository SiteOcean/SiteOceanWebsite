    ...
    <div className="bg-white min-h-[90vh]">
      <div className="max-w-7xl mx-auto py-7 sm:py-10 px-6 lg:px-8">
        <div className="md:text-center">
          <h2 className="text-xl tracking-tight bg-gradient-to-r sm:p-0 from-[#b73edb] to-[#fc0ef0] text-transparent bg-clip-text sm:text-2xl font-bold">
