      ...
      <div className="container mx-auto px-4 w-[80%]">
        <div className="flex flex-wrap items-center justify-between">
          <div className="w-full md:w-1/4 text-center md:text-left p-3">
            <h2 className=" text-lg text-[#b936ec] font-bold leading-tight mb-2">Site Ocean Private Limited</h2>
          ...
          <div className="w-full md:w-1/4 text-center md:text-left">
            <h2 className=" text-xl font-bold leading-tight mb-2 text-[#b936ec]">Social Media</h2>
